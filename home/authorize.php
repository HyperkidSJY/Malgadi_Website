        ...
        <div class="formcontainer">
            ...
            <div class="forminner">
                ...
                <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" class="login">
                    <div class="field">
                        <input type="tel" value="<?php if (isset($_COOKIE["mobile"])){echo $_COOKIE["mobile"];}?>" placeholder="Mobile" required name="mobile" id="mobile">
                    </div>
                    <div class="field">
                ...
                <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" class="signup">
                    ...
                    <div class="field">
                        <input type="tel" placeholder="mobile no." required name="mobile" id="mobile">
                    </div>
...
if (isset($_POST['login'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($num == 1) {
            ...
            echo"<script>alert('Mobile number not found');
                window.history.back(1);</script>";
        }
    }
}
