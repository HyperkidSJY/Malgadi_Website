...
<style>
    .my-navbar, .mCustomScrollBox, .navbar, .drop .drop-items{
...
<body>
    <nav class="my-navbar">
        ...
        <form action="../books/search.php" method="get">
            <input type="search" name="q" id="search" placeholder="Search for books...">
            <button><i class="fa fa-search" aria-hidden="true"></i></button>
        </form>
        <ul>
            <li class="drop"><a role="link" aria-disabled="true">Categories<i class="fa fa-caret-down" aria-hidden="true"></i></a>
                <ul class="drop-items">
                    <li class="d-item"><a href="category.php?q=CE">CE</a></li>
                    <li class="d-item"><a href="category.php?q=IT">IT</a></li>
                    <li class="d-item"><a href="category.php?q=IT">EC</a></li>   
                    <li class="d-item"><a href="category.php?q=MH">MH</a></li>   
                    <li class="d-item"><a href="category.php?q=CH">CH</a></li>   
                    <li class="d-item"><a href="category.php?q=IC">IC</a></li>   
                    <li class="d-item"><a href="category.php?q=CL">CL</a></li>   
                </ul>
            </li>
        </ul>
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <li><a href="category.php?q=CE">CE</a></li>
                    <li><a href="category.php?q=IT">IT</a></li>
                    <li><a href="category.php?q=IT">EC</a></li>   
                    <li><a href="category.php?q=MH">MH</a></li>   
                    <li><a href="category.php?q=CH">CH</a></li>   
                    <li><a href="category.php?q=IC">IC</a></li>   
                    <li><a href="category.php?q=CL">CL</a></li>   
                    </ul>
                </li>
                <li>
                    <a href="../books/review.php">Review Us</a>
                </li>
                <li>
                    <a href="../books/reviews.php">Reviews</a>
                </li>
                <li>
                    <a href="../books/contact.php">Contact Us</a>
                </li>
            </ul>
        </nav>
